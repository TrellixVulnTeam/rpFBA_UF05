...
docker run -v ${PWD}/inside_run_sbml.sh:/home/inside_run_sbml.sh -v ${PWD}/tool_rpFBA.py:/home/tool_rpFBA.py -v ${PWD}/test_rpCofactors.sbml:/home/test_rpCofactors.sbml -v ${PWD}/test_inSBML.sbml:/home/test_inSBML.sbml -v ${PWD}/results/:/home/results/ --rm brsynth/rpfba /bin/sh /home/inside_run_sbml.sh
